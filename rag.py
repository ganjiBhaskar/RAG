...
f = open(r"C:\Users\Ganji Bhaskar\Videos\key_genai.txt")
key = f.read()
...
#Loading Document
loader = PyPDFLoader(r"C:\Users\Ganji Bhaskar\Downloads\RAG_System_with_LangChain_Framework-main\RAG_System_with_LangChain_Framework-main\2404.07143.pdf")
